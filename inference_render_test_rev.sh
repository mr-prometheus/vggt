#!/bin/bash
#SBATCH -J vggt_infer_test_rev
#SBATCH --mem=40GB
#SBATCH --gres=gpu:1 -C gmem24
#SBATCH --output=runs/inference_render_test_rev_%j.out

# ==== CONFIGURATION ====
VIDEO_DIR="/home/c3-0/datasets/BDD_Dataset/Videos/bdd100k/videos/val/"
FILENAME_LIST="gama_list/val_day_vid.list"
TEMP_FRAMES_DIR="extracted_clips_test_tmp_rev"    # separate dir to avoid collision
...
CSV_LOCK="runs/inference_progress_test.csv.lock"  # shared lock file
...
echo "===================================================="
echo "VGGT Inference + Render Pipeline (TEST/VAL — REVERSED)"
...
# ======================================================
TEMP_LIST="/tmp/vggt_single_test_rev_$$.list"
...
process_videos(
    ...
    output_csv='/tmp/vggt_meta_test_rev.csv',
